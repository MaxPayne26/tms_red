...
class SystemSettings extends DBConnection{
    ...
    function update_settings_info(){
        ...
        if ($this->userdata('username') !== 'admin') {
            return json_encode(array('status' => 'error', 'message' => 'Access Denied. Only admin can update settings.'));
        }
        ...
        if ($update && $flash) {
            // var_dump($_SESSION);
            return json_encode(array('status' => 'success', 'message' => 'System settings updated successfully.'));
        }
    }
