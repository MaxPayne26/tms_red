	...
	<div class="card-body">
        ...
        <table class="table table-stripped text-dark">
            ...
            <tbody>
                <?php 
                $i = 1;
                // Updated query to include tourist spot details
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <?php if (!empty($row['package_title']) && !empty($row['tourist_spot_title'])): ?>
                                <?php echo $row['package_title']; ?> 
                                (<?php echo $row['tourist_spot_title']; ?> - ID: <?php echo $row['tourist_spot_id']; ?>)
                            <?php elseif (!empty($row['package_title'])): ?>
                                <?php echo $row['package_title']; ?>
                            <?php elseif (!empty($row['tourist_spot_title'])): ?>
                                <?php echo $row['tourist_spot_title']; ?>
                            <?php else: ?>
